...
test("3 — no page can ship unclassified: the two lists cover every HTML file, exactly once", () => {
  ...
  // The generated pages are covered too — they are the ones easiest to forget.
  for (const g of ["404.html", "docs.html"]) {
    assert.ok(INTERNAL_HTML.includes(g), `${g} is generated by the build and must be classified`);
  }
});
