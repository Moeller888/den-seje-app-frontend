...
| [167a-phase2-base-assembly-masks-review.md](./167a-phase2-base-assembly-masks-review.md) | 167A **Phase-2 base-assembly tooling review (2026-07-07)**: sign-off review of `tools/avatar/build-base-assembly-masks.mjs` output — **tooling PASS / owner-review-ready** (head contribution localized 92,337 px; body-below-seam IoU 1.0000; full-figure diff = bald crown by design; masks = approximate review-only proposals needing refinement; underarms = highest-risk sub-area). **NOT a Gate-2 pass; Gate 2 REOPENED / UNDER RECOVERY; Gate 3 PAUSED; no neutral outfit executed; no completed base; `AVATAR_R2` false.** | Authoritative (review) |
