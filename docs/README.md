...
| [167a-phase2-base-recovery-decision.md](./167a-phase2-base-recovery-decision.md) | 167A **Phase-2 base recovery decision (D-043)**: iter7 invalidated (bust/chest-plate); Gate-2 CONDITIONAL PASS withdrawn; `recovery-base-v1-blankface.png` adopted as the new recovery base geometry basis (not passed — needs registration + neutral outfit + 164B.3). | Authoritative (decision) |
