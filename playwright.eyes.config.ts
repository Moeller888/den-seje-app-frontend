// Isolated Playwright config for the fixture-based Avatar R2 eyes/glasses spec ONLY (D-080).
//
// Runs tests/avatar-r2-eyes.spec.ts with ZERO backend contact — no globalSetup (so the live Supabase
...
export default defineConfig({
  testDir: "./tests",
  testMatch: "avatar-r2-eyes.spec.ts",
  fullyParallel: false,
  workers: 1,
  retries: 0,
  reporter: "line",
