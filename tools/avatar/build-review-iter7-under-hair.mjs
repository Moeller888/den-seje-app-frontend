...
//   review-iter7-under-hair.png             (iter5 + hair, over white)
//   review-iter7-under-hair-with-master-ghost.png  (+ faint Master outline for alignment)
//   review-iter7-under-hair-on-dark.png     (over dark bg → reveals alpha/silhouette gaps)
...
const ITER5 = join(PKG, "body-neutral-medium-v2-candidate-iter7-shaded.png");
const W = 1024, H = 1536;
...
function main(){
  ...
  writeFileSync(join(PKG,"review-iter7-under-hair.png"),encRGB(W,H,white));

  const dark=compose([38,40,46]);
  writeFileSync(join(PKG,"review-iter7-under-hair-on-dark.png"),encRGB(W,H,dark));
  ...
  writeFileSync(join(PKG,"review-iter7-under-hair-with-master-ghost.png"),encRGB(W,H,ghost));

  console.log("✔ review composition written (review-only, not runtime):");
  console.log("  hair overlay px (Master brown detection): "+hairPx);
  console.log("  review-iter7-under-hair.png");
  console.log("  review-iter7-under-hair-with-master-ghost.png (cyan = Master outline)");
  console.log("  review-iter7-under-hair-on-dark.png");
