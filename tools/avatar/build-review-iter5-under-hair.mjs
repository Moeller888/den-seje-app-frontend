...
//   review-iter5-under-hair.png             (iter5 + hair, over white)
//   review-iter5-under-hair-with-master-ghost.png  (+ faint Master outline for alignment)
//   review-iter5-under-hair-on-dark.png     (over dark bg → reveals alpha/silhouette gaps)
...
function main(){
  ...
  writeFileSync(join(PKG,"review-iter5-under-hair.png"),encRGB(W,H,white));

  const dark=compose([38,40,46]);
  writeFileSync(join(PKG,"review-iter5-under-hair-on-dark.png"),encRGB(W,H,dark));
  ...
  writeFileSync(join(PKG,"review-iter5-under-hair-with-master-ghost.png"),encRGB(W,H,ghost));

  console.log("✔ review composition written (review-only, not runtime):");
  console.log("  hair overlay px (Master brown detection): "+hairPx);
  console.log("  review-iter5-under-hair.png");
  console.log("  review-iter5-under-hair-with-master-ghost.png (cyan = Master outline)");
  console.log("  review-iter5-under-hair-on-dark.png");
