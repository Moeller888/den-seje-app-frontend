...
-- Applied to live DB 2026-06-12 via Supabase migration API as
-- "avatar_identity_foundation_152a" (supabase db push is blocked by
-- pre-existing migration-history drift — see Section 153). This file is the
-- canonical documentation of what was applied.
--
...
--   DROP FUNCTION IF EXISTS public.validate_avatar_identity();
--   DROP FUNCTION IF EXISTS public.set_avatar_identity(TEXT);
--   -- column may remain; frontend resolver falls back to neutral.
