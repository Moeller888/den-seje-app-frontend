...
--
-- No schema changes. No backfill. Existing profiles with absent hairstyle key
-- remain valid via Model B runtime fallback (hairSrcFor → "default").
--
-- Valid hairstyles after 153A: 'default', 'braid', 'short', 'curly', 'long', 'sidecut', 'buzzcut'
-- Valid body types: 'male', 'female', 'neutral'  (unchanged)
--
-- Rollback:
--   Re-apply 20260612020000_avatar_hairstyle_152d.sql via apply_migration.
